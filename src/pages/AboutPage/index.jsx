  ...
  return (
    <Grid container className={classes.aboutPage}>
      ...
      <Member
        ...
        occ1="Founder & Design Lead"
        occ2="Web Developer | UI/UX Designer"
        linkedIn="https://www.linkedin.com/in/devraj-chatribin/"
        instagram="https://www.instagram.com/cuppycake_001/"
        github="https://github.com/DevrajDC"
        website="https://devraj-chatribin.netlify.app/"
      />
      <Member
        image={Ankita}
        name="Ankita Sahu"
        occ1="Events & Graphics Lead"
        occ2="Web Developer | Content Writer"
        linkedIn="https://www.linkedin.com/in/ankita-sahu-540920201/"
        github="https://github.com/SAHU-01"
      />
      <Member
        image={Jaagrav}
        name="Jaagrav Seal"
        occ1="Development Lead"
        occ2="Creative Web Developer"
        linkedIn="https://www.linkedin.com/in/jaagrav/"
        github="https://github.com/Jaagrav/"
        website="https://xjaagrav.netlify.app/stories"
      />
      <Member
        image={Shrutika}
        name="Shrutika Gawas"
        occ1="Social Media Administrator"
        occ2="Web Developer"
        linkedIn="https://www.linkedin.com/in/shrutika-g-40829910b/"
        instagram="https://www.instagram.com/shrutikagawas/"
      />
      <Member
        image={Trusha}
        name="Trusha Neogi"
        occ1="Graphic & Content Lead"
        occ2="Graphic Designer"
        linkedIn="https://www.linkedin.com/in/trusha-neogi-6a69bb191/"
        instagram="https://www.instagram.com/tuuushaa/"
      />
      <Member
        image={Shridhar}
        name="Shridhar Kamat"
        occ1="Development Team"
        occ2="Web Developer"
        linkedIn="https://www.linkedin.com/in/shridhar-kamat-1015a41bb"
        github="https://github.com/Shridhar-dev"
        website="https://thehardwaronzone.com/"
      />
